	...
	return (
		<Section id="contact">
			<Vstack className={styles.Contactsection}>
				...
				<Divider />
				<Text>
					I&apos;m currently looking for a <strong>JavaScript / React Developer</strong> position, so if you
					have an offer, or just want to reach out to say hi, my inbox is always open!
				</Text>
